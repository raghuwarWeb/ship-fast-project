    ...
    return (
        ...
        <div>
            ...
            <div className="overflow-x-hidde">
                <section className="bg-black bg-[url(/assets/images/modern-saas/banner-bg.png)] bg-cover bg-top bg-no-repeat pt-[82px] lg:pt-[106px]">
                    <div className="container lg:pt-7">
                        <div className="relative">
                            <div className=" text-left text-white lg:w-3/5 lg:py-20 ltr:lg:text-left rtl:lg:text-right">
                                ...
                                <label htmlFor="fileInput" className=" cursor-pointer btn mx-auto mt-2 block w-fit bg-white lg:mx-0 lg:rtl:ml-auto">
                                {/* <FaCloudUploadAlt /> */}
                            ...
                            <div
                                className=" flex justify-end top-[50px] w-full pb-7 ltr:right-0 rtl:left-0 rtl:right-auto lg:absolute  lg:pb-0 xl:ltr:-right-48 xl:rtl:-left-52"
                                data-aos={isRtl ? 'fade-right' : 'fade-left'}
                                data-aos-duration="1000"
                            >
                              <Image width={500} height={550} className='mt-16  h-auto' src="/assets/images/modern-saas/banner1.png" alt="" />
                ...
                <section   className="py-14 dark:bg-black-dark lg:py-[100px] bg-gradient-to-l from-red-50 ">
                        ...
                        <div className="mt-16 grid gap-x-7 gap-y-12 text-lg font-semibold sm:grid-cols-2 lg:grid-cols-3 lg:gap-y-20">
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div className="flex-1">
                                    <h3 className="mb-6 text-[22px] font-bold text-black dark:text-white">99.6% Accuracy</h3>
                            ...
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div className="flex-1">
                                    <h3 className="mb-6 text-[22px] font-bold text-black dark:text-white">Instant Conversions</h3>
                            ...
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div className="flex-1">
                                    <h3 className="mb-6 text-[22px] font-bold text-black dark:text-white">Fully Automatic</h3>
                            ...
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div className="flex-1">
                                    <h3 className="mb-6 text-[22px] font-bold text-black dark:text-white">Expert Support</h3>
                                    <p className="line-clamp-3">Real-time analytics is the discipline that applies logic and mathematics to data....</p>
                                </div>
                            </div>
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div className="flex-1">
                                    <h3 className="mb-6 text-[22px] font-bold text-black dark:text-white">#1 Bank Converter</h3>
                                    <p className="line-clamp-3">A customer journey map is a visual representation of a customer’s experience with a company.</p>
                                </div>
                            </div>
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div className="flex-1">
                                    <h3 className="mb-6 text-[22px] font-bold text-black dark:text-white">Unique Features</h3>
                    ...
                    <div className="container">
                        ...
                        <div className="grid gap-14 sm:grid-cols-2 lg:grid-cols-3">
                            <div data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <Link href="/services-detail" className="text-lg font-bold text-secondary transition hover:text-primary">
                                    Read More +
                                </Link>
                            </div>
                            <div data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <Link href="/services-detail" className="text-lg font-bold text-primary transition hover:text-secondary">
                                    Read More +
                                </Link>
                            </div>
                            <div data-aos="fade-up" data-aos-duration="1000">
                ...
                <Faq1 showTitle={true} type="modern-saas" queries={faqs} />
                        ...
                        <div className="flex flex-col justify-between gap-5 md:flex-row">
                            <div className="relative text-center md:w-1/2 ltr:md:text-left rtl:md:text-right xl:pr-12">
                                ...
                                <form className="relative mt-14">
                                    ...
                                    <button
                                        type="button"
                                        className="absolute top-1/2 -translate-y-1/2 -translate-x-full rounded-md bg-secondary px-3 py-1.5 font-bold text-white transition hover:bg-primary ltr:right-4 rtl:left-4 lg:py-2 lg:text-lg"
                                    >
                                        subscribe
                                    </button>
                                </form>
